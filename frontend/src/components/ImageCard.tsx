  ...
  return (
    <Card onClick={() => onClick(image)} className='group cursor-pointer relative rounded-lg'>
      <CardMedia
        ...
        className='w-full h-52 object-cover transition-transform transform group-hover:scale-105'
      />
...
//w-full h-52 object-cover rounded-lg transition-transform transform group-hover:scale-105"