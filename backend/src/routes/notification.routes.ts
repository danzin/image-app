...
export class NotificationRoutes {
	...
	private initializeRoutes(): void {
		...
		protectedRouter.get("/unread-count", asyncHandler(this.controller.getUnreadCount));
		protectedRouter.post("/read/:notificationId", asyncHandler(this.controller.markAsRead));
		protectedRouter.post("/read-all", asyncHandler(this.controller.markAllAsRead));
