/**COMPLETELY REFACTOR THE REPOSITORIES, ALL OF THEM. THEY SHOULD 
 * Know only about database operations (CRUD)
 * Not know about business rules
 * Be focused on one entity/collection
 * Not depend on other repositories directly */
...
import mongoose, { Model, ObjectId, ClientSession } from 'mongoose';
...
export class ImageRepository implements BaseRepository<IImage> {
   ...
   */
    ...
    //refactor attempt
    async find(criteria: any, session?: ClientSession): Promise<IImage[]> {
